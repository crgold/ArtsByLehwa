...
export default function Home() {
  return (
    <div>
      ...
      <header>
        <nav className={[styles.nav] + " " + [playfair.className]}>
          <h1>Arts By Lehwa</h1>
          <ul>
            <li>
              <Link href="/#" >
      ...
      <header className={styles.header}>
        <div className={[styles.headerTextContainer] + " " + [montserrat.className]}>
          <h1>MABUHAY!<br />I&apos;M LEHWA <span className={styles.textGold}>GOLD</span></h1>
          <h2>painter <span className={styles.textRed}>/</span> digital artist</h2>
        </div>
